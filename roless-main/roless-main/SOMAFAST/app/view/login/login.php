              ...
              <div class='col-md-8 col-lg-6 col-xl-4 offset-xl-1'>
                <form method='POST' action='../../controller/login.php' id='login' autocomplete='off'>
                  ...
                  <div class='form-outline mb-4'>
                    ...
                    <label class='form-label' for='p_username'>Nombre de usuario</label>
                  </div> 
                  <!-- Password input -->
                  <div class='form-outline mb-3'>
                    <input type='password' id='p_pass' name='p_pass' class='form-control form-control-lg'
                      placeholder='Ingresar contraseña' />
                    <label class='form-label' for='p_pass'>contraseña</label>
                  </div>
                  <div  class='d-flex justify-content-between align-items-center'>
                    <a href='../../view/login/recuperar.php' class='text-body'>Olvidaste tu contraseña?</a>
                  </div>
                  <div class='text-center text-lg-start mt-4 pt-2'>
                    <button type='submit' class='btn btn-primary btn-lg'
                      style='padding-left: 2.5rem; padding-right: 2.5rem;'>Login <a href='../../view/home/home.php'></a></button>
                    <p class='small fw-bold mt-2 pt-1 mb-0'>No tienes cuenta? <a href='../../view/login/register.php'
