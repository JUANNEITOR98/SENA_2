                            ...
                            <div class='row g-0'>
                                <div class='col-lg-6'>
                                    <div class='card-body p-md-5 mx-md-4'>
                                        <div class='text-center'>
                                            <img src='../assets\img\icons\logo_oficial.png'
                                                style='width: 185px;' alt='logo'>
                                            <h4 class='mt-1 mb-5 pb-1'>Bienvenido a la sazon de juanita </h4>
                                        </div>
                                        <form method='POST' action='../../controller/login.php' id='login' autocomplete='off'>
                                            <p>por favor ingresa tu cuenta de administrador</p>
                                            ...
                                            <div class='text-center pt-1 mb-5 pb-1'>
                                                <button class='btn btn-primary btn-block fa-lg gradient-custom-2 mb-3' type='submit'><a href='../crud/crud.php' style='text-decoration: none; color: white;'>Ingresar</a></button>
                                                <a class='text-muted' href='../login/recuperar.php' style='text-decoration: none;'>¿olvidaste tu contraseña?</a>
                                            </div>
                                ...
                                <div class='col-lg-6 d-flex align-items-center gradient-custom-2'>
                                    <div class='text-white px-3 py-4 p-md-5 mx-md-4'>
                                        <h4 class='mb-4'>Bienvenido administrador ¿que tal va tu dia?</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
